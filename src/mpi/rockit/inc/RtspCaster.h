...
* @param context	回调环境 
*/
typedef void(*CasterEventCallback)(const struct CasterEvent* event, void* context);


#endif //CASTER_TYPE


typedef struct CasterEvent	RtspCasterEvent;
typedef struct MPacket	MPacket;
typedef struct MFormat MFormat;
